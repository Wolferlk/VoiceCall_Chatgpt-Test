...
//
  ...
  async function startMicCapture() {
    ...
    processor.onaudioprocess = (e) => {
      ...
      // Manual pause/mute always wins. Otherwise gate the mic during AI speech so the
      // caller can still barge in over the AI, while its own echo stays suppressed.
      const muteMic = callPausedRef.current || micMutedRef.current || (aiSpeaking && !callerBargingIn);
